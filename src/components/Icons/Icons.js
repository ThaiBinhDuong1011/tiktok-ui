...
export const EnglishIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const KeyboardShortcutsIcon = ({ width = '2rem', height = '2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const BlueTickIcon = ({ width = '1.4rem', height = '1.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        fontSize="14px"
...
export const HeartVideoIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        fontSize="14px"
...
export const HeartVideoActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
...
export const OpenCommentIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        fontSize="14px"
